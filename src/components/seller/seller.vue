    ...
    <div class="seller" ref="seller">
        <div class="seller_content">
            ...
            <div class="bulletin">
                ...
                <div class="content_wrapper border-1px">
                    <p class="content">{{seller.bulletin}}</p>
                </div>
                <ul v-if="seller.supports" class="supports">
                    <li v-for="(item, index) in seller.supports" class="support_item border-1px" :key="index">
            ...
            <div class="pics">
                ...
                <div class="pic_wrapper" ref="picWrapper">
                    <ul class="pic_list" ref="picList">
                        <li class="pic_item" v-for="(pic, index) in seller.pics" :key="index"><img :src="pic" alt="" width="120" height="90" ></li>
                    </ul>
                </div>
