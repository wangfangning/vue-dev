<template>
    <div class="ratings" ref="ratings">
        <div class="ratings_content">
            ...
            <split></split>
            <ratingselect @toggle="toggleCount" @select="selectRating" :selectType="selectType" :onlyContent="onlyContent" :ratings="ratings"></ratingselect>
            <div class="rating_wrapper">
                <ul>
                    <li v-show="needShow(rating.rateType,rating.text)" v-for="(rating, index) in ratings" class="rating_item" :key="index">
                        <div class="avatar">
